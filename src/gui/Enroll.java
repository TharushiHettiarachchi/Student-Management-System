...
public class Enroll extends javax.swing.JFrame {
    ...
    public void loadTable() {
        try {
            ...
            ResultSet resultSet = MYSQL.search("SELECT * FROM `class_enrollment`");
    ...
    private void initComponents() {
        ...
        setTitle("Adyapana Institute - Enrollment");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String classes = jComboBox1.getSelectedItem().toString();
            ...
            String query = "INSERT INTO `class_enrollment`(`student_Sno`,`class_classNo`) VALUES ('" + studentId + "','" + classes + "')";
            MYSQL.iud(query);
            loadTable();
            reset();
        }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        if (evt.getClickCount() == 2) {
            ...
            String subjectName = String.valueOf(jTable1.getValueAt(selectedRow, 0));
            jTextField2.setText(subjectName);

            String classes = String.valueOf(jTable1.getValueAt(selectedRow, 1));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (selectedRow == -1) {
            ...
            try {
                ...
                MYSQL.iud("DELETE FROM `class_enrollment` WHERE `class_classNo` = '" + classes + "' AND `student_Sno` = '"+studentId+"'");
                loadTable();
                reset();
